...
public class ShoppingCartServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7179788020786159312L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for(int i =0; i<cookies.length;i++){
            ...
            System.out.println("Recived the cookie " + name + "=" + value);
        }
        ...
        //Add the content to the shopping cart to the Web page
